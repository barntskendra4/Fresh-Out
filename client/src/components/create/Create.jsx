...
const Create = () => {
    ...
    return (
        <section>
            <NavBar />
            <header>
                <h1>Fresh Out the Gate</h1>
                <i>Sign up</i>
            </header>
            <section className='orderForm'>
                <Form action="http://localhost:8080/user" method="post" noValidate validated={validated} onSubmit={handleSubmit} >
                    <Row className="mb-3">
                    ...
                    <button className='sub' type="submit" value='submit'>Create Account</button>
                </Form>
            </section>
        </section>
    )
